...
import 'package:tic_tac_go_project/models/Player.dart';
...
class _GameBoardState extends State<GameBoard> with TickerProviderStateMixin {
  ...
  _drawBoardTile(GamePiece gamepiece, position, {border}) {
    Color pieceColor = primaryLightColor;
    ...
    switch (gamepiece.pieceType) {
      ...
      default:
        pieceColor = Colors.blueGrey[500];
        break;
    }
      ...
      child: Column(
        children: <Widget>[
          ...
          Text(
            score.toString(),
            style:
            TextStyle(color: primaryColor, fontSize: 30.0),
          ),
        ],
      ),
    );
